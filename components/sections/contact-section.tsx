...
const socialLinks = [
  ...
  },
  {
    name: "GitHub",
    icon: Github,
    color: "bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900",
        ...
        >
          ...
          <div className="text-center mb-20">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Ready to collaborate on an exciting project? Let's build something amazing together and bring your ideas to life.
            </motion.p>
          </div>
                ...
                >
                  <Card className="bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 border border-slate-700/50 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden h-full transition-all duration-500 hover:shadow-3xl">
                    <CardContent className="p-8 text-center">
                      <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${method.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
            ...
            >
              <Card className="bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 border border-slate-700/50 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden">
                <CardHeader>
                  ...
                  <p className="text-slate-400 text-lg">Fill out the form below and I'll get back to you within 24 hours.</p>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                  {availability.map((schedule, index) => (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm">{schedule.time}</p>
                        <p className="text-slate-500 text-xs mt-1">{schedule.description}</p>
                      </div>
                    </motion.div>
                  ))}
                  ...
                  <div className="p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-2xl">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <p className="text-blue-400 font-semibold text-lg">Response Time</p>
                        <p className="text-slate-300 text-base">I typically respond within 12-24 hours during business days.</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-8">
                    <div className="flex items-start space-x-6">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-2 text-xl">Location</h4>
                    ...
                    <div className="flex items-start space-x-6">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-2 text-xl">Current Time</h4>
                        <p className="text-slate-400 text-base">Jakarta Time (WIB)</p>
                    ...
                    <div className="flex items-start space-x-6">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-2 text-xl">Remote Work</h4>
                        <p className="text-slate-400 text-base mb-3">Available for remote collaboration worldwide</p>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-slate-400 text-lg">Choose your preferred way to get in touch</p>
            </div>
                  ...
                  >
                    <Card className="bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 border border-slate-700/50 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden h-full transition-all duration-500 hover:shadow-3xl">
                      <CardContent className="p-6 text-center">
                        <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl ${social.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          <Icon className="h-8 w-8 text-white" />
                        </div>
                        <h4 className="text-white font-semibold text-lg mb-2">{social.name}</h4>
                        <p className="text-slate-400 text-sm mb-4">{social.description}</p>
                        <Button 
                          variant="outline"
                          size="sm"
          ...
          >
            <div className="bg-gradient-to-r from-slate-900/50 via-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-12 shadow-2xl">
              ...
              <p className="text-slate-400 mb-8 text-xl max-w-3xl mx-auto leading-relaxed">
                Whether you have a groundbreaking idea, need technical expertise, or just want to chat about the latest in AI and technology, I'm here to help bring your vision to life.
              </p>
