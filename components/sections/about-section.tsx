            ...
            <Tabs defaultValue="intro" className="space-y-12">
              ...
              <div className="flex justify-center">
                <TabsList className="grid grid-cols-2 lg:grid-cols-4 bg-gradient-to-r from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-slate-700/50 p-2 rounded-2xl shadow-2xl min-w-fit">
                  <TabsTrigger
                    value="intro"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-cyan-500 data-[state=active]:text-white rounded-xl px-6 py-2.5 text-sm font-medium transition-all duration-300 flex items-center gap-2 min-w-[120px] justify-center"
                  >
                  ...
                  <TabsTrigger
                    value="experiences"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-500 data-[state=active]:to-emerald-500 data-[state=active]:text-white rounded-xl px-6 py-2.5 text-sm font-medium transition-all duration-300 flex items-center gap-2 min-w-[120px] justify-center"
                  >
                  ...
                  <TabsTrigger
                    value="educations"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-violet-500 data-[state=active]:text-white rounded-xl px-6 py-2.5 text-sm font-medium transition-all duration-300 flex items-center gap-2 min-w-[120px] justify-center"
                  >
                  ...
                  <TabsTrigger
                    ...
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-pink-500 data-[state=active]:text-white rounded-xl px-6 py-2.5 text-sm font-medium transition-all duration-300 flex items-center gap-2 min-w-[120px] justify-center"
                  >
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <a href="https://www.linkedin.com/in/zidan-mubarak/" target="_blank" rel="noopener noreferrer">
