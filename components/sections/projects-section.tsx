...
const projects = [
  {
    ...
    description:
      "A professional implementation of a neural network using only NumPy for MNIST digit classification with detailed explanations and visualizations.",
    image:
  ...
  },
  {
    ...
    description:
      "My personal portfolio site, powered by Django and TailwindCSS, running on serverless architecture with modern design principles.",
    image:
  ...
  },
  {
    ...
    title: "BeliMadu.com",
    description:
      "E-commerce hotspot for honey treats, built with Django and Bootstrap, featuring secure payment integration and inventory management.",
    image:
  ...
  },
  {
    ...
    description:
      "API unlocking Indonesia's higher education data from PDDikti with comprehensive data processing and analytics capabilities.",
    image:
  ...
  },
  {
    ...
    description:
      "REST API and website loaded with Mobile Legends game stats, providing real-time data and comprehensive analytics dashboard.",
    image:
  ...
  },
  {
    ...
    description:
      "Interactive dashboard tying weather to bike rental trends with predictive analytics and beautiful data visualizations.",
    image:
                            ...
                            project.tech.map((tech, techIndex) => {
                              ...
                              return IconComponent ? (
                                <motion.div
                                  ...
                                  className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-800 border border-slate-700 shadow-md transition-all duration-300 hover:scale-110"
                              ...
                              ) : null; // Only render if icon is available
                            })
                          ) : (
