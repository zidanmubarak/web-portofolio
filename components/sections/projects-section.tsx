...
import { ExternalLink, Github, Star, Filter, Code2, Brain, Database, Globe, Play, ArrowUpRight, Sparkles, Eye, Heart, Zap, Rocket, CloudLightning as Lightning, Layers, Cpu } from 'lucide-react';
